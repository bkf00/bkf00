...
> Debugging joke of the day: my code does not have bugs, it has undocumented surprise features waiting for unit tests.
...
| --- | --- |
| [TaskWizard](https://github.com/bkf00/TaskWizard) | AI-assisted task extraction from Teams / Outlook sources, approval workflow, audit trail, Planner sync direction, Next.js / TypeScript skeleton, local MVP runner. |
| [PolicyInsurance](https://github.com/bkf00/PolicyInsurance) | Clean architecture backend exercise for a Romanian insurance domain: clients, buildings, geography, validation, REST design, tests. |
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=cs,dotnet,ts,js,nextjs,nodejs,postgres,sqlite,git,github,visualstudio,vscode" alt="Tech stack icons" />
</p>
...
- **boring in production** - predictable, observable, and easy to reason about;
- **clear in code review** - names, boundaries, and tests should explain the intention;
- **practical before fancy** - the best abstraction is the one that pays rent;
- **built with users in mind** - even internal tools deserve good flow and low friction.
...
### Let's build software that behaves nicely, reads clearly, and survives Monday morning.
